...
public class CalculatePlacedSpawnerRankSpec extends SelectSqlSpec<Table<Integer, SpawnerType, Integer>> {
    ...
    public PreparedStatementCreator getPreparedStatementCreator() {
        return connection -> {
            ...
            String query = String.format(
                    "SELECT `faction_id`, `type`, COUNT(*) as 'total' FROM `%s` WHERE `state` = 'PLACED' GROUP BY `faction_id`, `type`;",
