...
public class AddPointsSubCommand extends CustomCommand implements GroupCommandRestrictable {

    public AddPointsSubCommand() {
        super("add", CommandRestriction.IN_GAME);

        registerArgument(new Argument("TAG", "Tag da facção.", true));
        registerArgument(new Argument("valor", "Pontos que deseja adicionar.", true));
    }
